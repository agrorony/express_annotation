...
```python
from pores_analysis.example_workflow import example_synthetic_data
...
1. Check [README.md](README.md) for module documentation
2. Run validation tests: `python test_psd_synthetic.py`
3. Review example workflows: `python example_workflow.py`
4. Inspect configuration template: `config_template.py`
