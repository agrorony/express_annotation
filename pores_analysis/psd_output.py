...
Output Format:
    ...
    - is_reliable: Boolean flag (True if d >= 5 voxels per Vogel et al.)
"""
...
def psd_to_dataframe(
    ...
    if include_metadata:
        ...
        df.attrs['min_reliable_diameter_voxels'] = 5  # Vogel et al. constraint
...
def plot_psd(
    ...
    Args:
        df: PSD DataFrame
        show_unreliable: If False, grey out unreliable region (d < 5 voxels)
